...
public class BookingTest {
    ...
    public void testAddGuest() {
        ...
        Booking booking = new Booking(0, new Date(), new Date(), new Room(0, null, 0, 0), guests);
    ...
    public void testGetId() {
        int id = 0;
        Booking booking = new Booking(id, new Date(), new Date(), new Room(id, null, id, id), new ArrayList<Guest>());
    ...
    public void testSetId() {
        int id = 0;
        Booking booking = new Booking(1, new Date(), new Date(), new Room(id, null, id, id), new ArrayList<Guest>());
        booking.setId(id);
        assertEquals(id, booking.getId());
    }
    ...
    public void testGetCheckinDate() {
        ...
        Booking booking = new Booking(0, checkinDate, new Date(), new Room(0, null, 0, 0), new ArrayList<Guest>());
    ...
    public void testSetCheckinDate() {
        Date checkinDate = new Date();
        Booking booking = new Booking(0, new Date(), new Date(), new Room(0, null, 0, 0), new ArrayList<Guest>());
    ...
    public void testGetCheckoutDate() {
        ...
        Booking booking = new Booking(0, new Date(), checkoutDate, new Room(0, null, 0, 0), new ArrayList<Guest>());
